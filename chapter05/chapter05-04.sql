...
-- 실제 테이블처럼 사용할 수 있도록 만든 데이터베이스 개체이다
...
-- book 테이블에서 '축구'라는 문구가 포함된 자료만 보여 주는 뷰를 만들어 보자
...
select od.orderid, od.custid, cs.name, od.bookid, 
...
-- vw_customer 주소가 '대한민국'인 고객을 보여 준다
